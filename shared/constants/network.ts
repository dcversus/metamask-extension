...
export const PALM_TOKEN_IMAGE_URL_DARK = './images/palm-dark.svg';
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP_DARK_MODE = {
  ...CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP,
  [CHAIN_IDS.PALM]: PALM_TOKEN_IMAGE_URL_DARK,
} as const;
